...
public abstract class Game extends Entity
{
    ...
    private void checkMapBorders() {
        ...
        if (x < viewportMinX && y < viewportMinY)
        {
            camera.position.x = viewportMinX;
            camera.position.y = viewportMinY;
        }else if(x > viewportMaxX && y > viewportMaxY)
        {
            camera.position.x = viewportMaxX;
            camera.position.y = viewportMaxY;
        }else if(x > viewportMaxX && y < viewportMinY)
        {
            camera.position.x = viewportMaxX;
            camera.position.y = viewportMinY;
        }else if(x < viewportMinX && y > viewportMaxY)
        {
            camera.position.x = viewportMinX;
            camera.position.y = viewportMaxY;
        }else if(x < viewportMinX)
        {
            camera.position.x = viewportMinX;
            camera.position.y = y;
        }else if(y < viewportMinY)
        {
            camera.position.y = viewportMinY;
            camera.position.x = x;
